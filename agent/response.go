...
type ChatResponse struct {
	...
	// agent loop. Populated for OpenAI Responses API; empty for chat completions
	// and other providers. Required by callers that want to chain the next turn
	// via WithOpenAIPreviousResponseID.
