...
var Models = map[string]llm.Model{
	...
	Sonar: {
		...
		State:                 "legacy",
		RetirementDate:        "2026-09-27",
		ReplacedBy:            "fast preset",
	},
	SonarDeepResearch: {
